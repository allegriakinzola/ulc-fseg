/**
 * Banque d'images (Unsplash) utilisée sur le site.
 * Toutes les URLs pointent vers images.unsplash.com (configuré dans next.config.ts).
 */
export const IMG = {
  heroCampus:
  ...
  handshake:
    "https://images.unsplash.com/photo-1559523161-0fc0d8b38a7a?auto=format&fit=crop&w=1400&q=80",
} as const;
